# Project Name: Amir's AI Chess Agent (AutoGen)
# Developer: Muhammad Amir (@codewith-amir)
# Year: 2026
...
if st.session_state.get("openai_api_key") and str(st.session_state.openai_api_key).strip():
    try:
...
""")
        ...
        st.write(initial_board_svg, unsafe_allow_html=True)
        ...
        if st.button("Start Game"):
            ...
            for i, move_svg in enumerate(st.session_state.move_history):
                ...
                st.write(move_svg, unsafe_allow_html=True)
